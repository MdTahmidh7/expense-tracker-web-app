...
@Component({
  ...
  styles: [`
    ...
    .login-card { max-width: 400px; width: 90%; border-radius: 16px; }
    .login-content { text-align: center; padding: 48px 24px !important; }
    .logo-icon { font-size: 64px; width: 64px; height: 64px; color: #3f51b5; margin-bottom: 16px; }
